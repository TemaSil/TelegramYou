 ...
 * overshooting is the whole screen swelling past its edges and back — it
 * read as the content shaking.
 *
...
fun Modifier.containerTransform(key: Any, shape: Shape, isScreen: Boolean = false): Modifier {
    ...
    return with(shared) {
        this@containerTransform.sharedBounds(
            ...
            // screen sixty times a second is what made opening a chat, when
            // it still opened this way, stutter. It is laid out once, at full size, and scaled
